...
if(isset($_POST['title'])) {
	...
	if($error=="") {
		...
		mysql_query("UPDATE `settings` SET `rootpath`='$path', `websiteName`='$title', `title`='$title' WHERE 1");
		mysql_query("UPDATE `user` SET `username`='$username', `password`='$password',`email`='$email' WHERE 1");
