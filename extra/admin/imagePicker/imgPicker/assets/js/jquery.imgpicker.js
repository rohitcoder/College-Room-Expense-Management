	...
	Plugin.prototype = {
		...
		crop: function(image) {
			...
			this.elem('.ip-save').on('click', function() {
				if ($("#bothAddEdit i").hasClass("fa fa-plus"))
				{
					$('#bothAddEdit i').removeClass('fa fa-plus');
					$('#bothAddEdit i').addClass('fa fa-pencil');
					$('#bothAddEdit').html('<i class="fa fa-pencil"></i> Update Image');
				} else {
					$('#bothAddEdit i').removeClass('fa fa-pencil');
					$('#bothAddEdit i').addClass('fa fa-plus');
					$('#bothAddEdit').html('<i class="fa fa-plus"></i> Add Image');
				}
                $.ajax({
