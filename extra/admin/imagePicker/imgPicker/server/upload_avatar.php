...
$options = array(
	...
	'upload_dir' => '../../../../images/productImages/',
    ...
    'max_width'  => null,
    'max_height' => null,
    'min_width'  => featuredImageWidth(),
    'min_height' => featuredImageHeight(),
    ...
    'versions' => array(
    	...
    	'avatar' => array(
    		...
    		// Create square image
    		'crop' => true,
    		'max_width' => productImageWidth(),
    		'max_height' => productImageHeight()
    	),
    ),
	...
	'crop_start' => function($image, $instance) {
		...
		$_SESSION['image']=$time.'-img.'.$image->type;
	},
